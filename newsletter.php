                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="row">
                                            ...
                                            echo '<div class="col-md-6">
                                                <div class="form-group"> <label for="form_email">Email *</label> <input id="form_email" type="email" name="emailid" class="form-control" placeholder="johnsmith@abc.com" default=' . $uemail . ' required="required" data-error="Valid email is required."> </div>
                                            </div>';
                                            ?>
                                            <div class="col-md-6">
